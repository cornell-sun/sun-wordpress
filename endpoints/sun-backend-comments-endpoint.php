...
class SunAppExtension_CommentsEndpoint {
    ...
    public static function init() {
        ...
        register_rest_route(
            PLUGIN_ENDPOINT . '/' . PRODUCTION_VERSION, '/comments/(?P<post_id>\d+)', array(
                'methods' => 'GET',
     ...
     */
    private static function __create_url_comments_request_url($post_url) {
     ...
     */
    private static function __create_user_picture_request_url($user_id) {
     ...
     */
    private static function __create_reply_comment_request_url($comment_id) {
     ...
     */
    private static function __get_batched_response($fb, $requests) {
        try {
